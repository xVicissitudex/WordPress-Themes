...
if ( ! class_exists( 'unBlock_Select_Control' ) ) {

	// Select control.
	class unBlock_Select_Control extends Wp_Customize_Control {
        ...
        public function enqueue() {
            ...
            wp_enqueue_script( 'unblock-select', get_template_directory_uri() . '/inc/customizer/custom-controls/select/select.js', array( 'jquery', 'selectize' ), false, true ); // for multi select    
        }
