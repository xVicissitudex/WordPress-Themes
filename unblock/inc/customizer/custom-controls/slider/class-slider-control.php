...
if ( ! class_exists( 'unBlock_Slider_Control' ) ) {

	/**
	 * Slider control (range).
	 */
	class unBlock_Slider_Control extends Wp_Customize_Control {
        ...
        public function enqueue() {            
            wp_enqueue_style( 'unblock-slider', get_template_directory_uri() . '/inc/customizer/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'unblock-slider', get_template_directory_uri() . '/inc/customizer/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); // for slider control               
        }
